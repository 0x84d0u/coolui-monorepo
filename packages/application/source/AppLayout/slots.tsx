...
export const SidebarWrapper = (props: {
    ...
    return <aside
        className={cn(
            ...
            "w-full tablet:w-64",
            // Fixed on mobile/tablet, Flex child on laptop
            props.isOpen && "fixed inset-y-0 left-0 top-(--cool-header-height) z-30",
...
export const HeaderWrapper = (props: {
    ...
    return <header
        className={cn(
            ...
            "border-b", props.showBorder ? "border-border" : "border-transparent",
...
export const HeaderToolbar = (props: { children: React.ReactNode }) => <div>{props.children} </div>
export const HeaderBranding = (props: { children: React.ReactNode }) => <div className="justify-self-center">{props.children} </div>
export const HeaderActions = (props: { children: React.ReactNode }) => <div className="justify-end">{props.children} </div>
